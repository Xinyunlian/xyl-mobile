...
@observer
export class Brief extends Component<BriefProps, any> {
    render() {
        return (
...
class ListItem extends BaseComponent<ListItemProps, any> {
    ...
    render() {
        ...
        const {
            ...
            children, multipleLine, thumb, extra, arrow, onClick, platform, ...restProps
        } = this.props;

        const {coverRipleStyle, RipleClicked} = this._state;
        const wrapCls = {
