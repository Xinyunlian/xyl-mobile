...
@observer
export default class ImagePicker extends Component<ImagePickerPropTypes, any> {
    ...
    fileSelectorInput;
    fileSelectorInputBind = (fileSelectorInput) => {
        this.fileSelectorInput = fileSelectorInput;
    }
    ...
    render() {
        const {
            prefixCls, style, className, files = [],
            selectable, onAddImageClick
        } = this.props;
        ...
        const selectEl = (
            <Touchable activeClassName={`${prefixCls}-upload-btn-active`}>
                ...
                >
                    <input
                        style={itemStyle}
                        ref={this.fileSelectorInputBind}
                        type="file"
